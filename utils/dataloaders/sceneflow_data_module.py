...
class SceneflowDataModule(pl.LightningDataModule):
    ...
    def setup(self):
        ...
        self.full_train_loader = SceneflowLoader(dataset=self.hparams.dataset,
                                                 dataset_path=dataset_path,
                                                 training=True,
                                                 validation=False,
                                                 transform=transform)
        self.test_dataset = SceneflowLoader(dataset=self.hparams.dataset,
                                            dataset_path=dataset_path,
                                            training=False,
                                            validation=True,
                                            transform=transform)
